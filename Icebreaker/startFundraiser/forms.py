...
class CampaignForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['campaign_Title', 'campaign_Tagline', 'campaign_Category', 'country', 'city', 'overview', 'goal',
                  'story', 'tags', 'campaign_Card_Image', 'image', 'video']
        widgets = {
...
#                  }
#         help_texts = {
#                          'amount': _('Price for which the reward can be claimed'),
#                          'perks': _('Describe the reward that you\'d like to offer to supporters'),
#                          'quantity': _('How many can be claimed?\nNot specified, will be considered as unlimited.'),
#                      }
