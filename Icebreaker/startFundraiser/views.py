...
from .forms import CampaignForm, UserForm, UpdateForm, FaqsForm, PostForm, createcomment, createreply, BackersForm, RewardModelFormset
...
def home(request):
    campaign_status()
    most_liked = Campaign.objects.order_by('-likes', '-pledged')[:5]
    return render(request, 'startFundraiser/home.html', {'most_liked': most_liked})
